...
interface PartyBidFactoryV2Interface extends ethers.utils.Interface {
  functions: {
    "deployedAt(address)": FunctionFragment;
    "logic()": FunctionFragment;
    "partyDAOMultisig()": FunctionFragment;
    "startParty(address,address,uint256,uint256,address,uint256,string,string)": FunctionFragment;
    "tokenVaultFactory()": FunctionFragment;
    "weth()": FunctionFragment;
  };

  encodeFunctionData(functionFragment: "deployedAt", values: [string]): string;
  ...
  events: {
    "PartyBidDeployed(address,address,address,uint256,address,uint256,address,uint256,string,string)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "PartyBidDeployed"): EventFragment;
}

export class PartyBidFactoryV2 extends Contract {
  ...
  interface: PartyBidFactoryV2Interface;
  ...
  functions: {
    ...
    "startParty(address,address,uint256,uint256,address,uint256,string,string)"(
      _marketWrapper: string,
      _nftContract: string,
      _tokenId: BigNumberish,
      _auctionId: BigNumberish,
  ...
  deployedAt(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
