...
["open_sea_metadata"]: AliasType<{
	...
	imageUrl?:boolean,
	name?:boolean,
openSeaResponse?: [{	/** JSON select path */
...
["party"]: AliasType<{
	...
	createdBy?:boolean,
	gatedToken?:boolean,
	gatedTokenAmount?:boolean,
	id?:boolean,
	marketWrapperAddress?:boolean,
	name?:boolean,
	...
	partyAddress?:boolean,
	partyType?:boolean,
party_claims?: [{	/** distinct select on columns */
	...
	where?:ValueTypes["party_claim_bool_exp"] | null},ValueTypes["party_claim"]],
party_contributions?: [{	/** distinct select on columns */
	...
	where?:ValueTypes["party_contribution_bool_exp"] | null},ValueTypes["party_contribution"]],
party_contributions_aggregate?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["party_contribution_select_column"][],	/** limit the number of rows returned */
	limit?:number | null,	/** skip the first n rows. Use only with order_by */
	offset?:number | null,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["party_contribution_order_by"][],	/** filter the rows returned */
	where?:ValueTypes["party_contribution_bool_exp"] | null},ValueTypes["party_contribution_aggregate"]],
party_createds?: [{	/** distinct select on columns */
	...
	where?:ValueTypes["party_created_bool_exp"] | null},ValueTypes["party_created"]],
party_finalizeds?: [{	/** distinct select on columns */
	...
	where?:ValueTypes["party_finalized_bool_exp"] | null},ValueTypes["party_finalized"]],
	splitBasisPoints?:boolean,
	splitRecipient?:boolean,
	symbol?:boolean,
	transactionHash?:boolean,
...
["party_claim"]: AliasType<{
	...
	run?:ValueTypes["run"],
	runId?:boolean,
	totalEthContributedWei?:boolean,
	totalEthReturnedWei?:boolean,
	totalTokensReceivedWei?:boolean,
	transactionHash?:boolean,
		__typename?: boolean
}>;
...
["party_contribution"]: AliasType<{
	...
	partyAddress?:boolean,
	partyId?:boolean,
	previousTotalContributedToPartyWei?:boolean,
	/** An object relationship */
	run?:ValueTypes["run"],
	runId?:boolean,
	totalFromContributorWei?:boolean,
	transactionHash?:boolean,
		__typename?: boolean
}>;
...
count?: [{	columns?:ValueTypes["party_contribution_select_column"][],	distinct?:boolean | null},boolean],
...
["party_contribution_bool_exp"]: {
	...
	partyAddress?:ValueTypes["String_comparison_exp"] | null,
	partyId?:ValueTypes["Int_comparison_exp"] | null,
	previousTotalContributedToPartyWei?:ValueTypes["numeric_comparison_exp"] | null,
	run?:ValueTypes["run_bool_exp"] | null,
	runId?:ValueTypes["Int_comparison_exp"] | null,
...
["party_finalized"]: AliasType<{
	...
	runId?:boolean,
	tokenVault?:boolean,
	totalContributedWei?:boolean,
	totalSpentWei?:boolean,
	transactionHash?:boolean,
	versionNumber?:boolean,
		__typename?: boolean
}>;
...
["party_order_by"]: {
	...
	party_claims_aggregate?:ValueTypes["party_claim_aggregate_order_by"] | null,
	party_contributions_aggregate?:ValueTypes["party_contribution_aggregate_order_by"] | null,
	party_createds_aggregate?:ValueTypes["party_created_aggregate_order_by"] | null,
	party_finalizeds_aggregate?:ValueTypes["party_finalized_aggregate_order_by"] | null,
...
bid?: [{	/** distinct select on columns */
	...
	where?:ValueTypes["bid_bool_exp"] | null},ValueTypes["bid"]],
bid_by_pk?: [{	id:number},ValueTypes["bid"]],
block?: [{	/** distinct select on columns */
	...
	where?:ValueTypes["block_bool_exp"] | null},ValueTypes["block"]],
block_by_pk?: [{	id:number},ValueTypes["block"]],
ens_lookup?: [{	/** distinct select on columns */
	...
	where?:ValueTypes["ens_lookup_bool_exp"] | null},ValueTypes["ens_lookup"]],
ens_lookup_by_pk?: [{	id:number},ValueTypes["ens_lookup"]],
eth_price?: [{	/** distinct select on columns */
	...
	where?:ValueTypes["eth_price_bool_exp"] | null},ValueTypes["eth_price"]],
eth_price_by_pk?: [{	id:number},ValueTypes["eth_price"]],
open_sea_metadata?: [{	/** distinct select on columns */
	...
	where?:ValueTypes["open_sea_metadata_bool_exp"] | null},ValueTypes["open_sea_metadata"]],
open_sea_metadata_by_pk?: [{	id:number},ValueTypes["open_sea_metadata"]],
party?: [{	/** distinct select on columns */
	...
	where?:ValueTypes["party_bool_exp"] | null},ValueTypes["party"]],
party_by_pk?: [{	id:number},ValueTypes["party"]],
party_claim?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["party_claim_select_column"][],	/** limit the number of rows returned */
	limit?:number | null,	/** skip the first n rows. Use only with order_by */
	offset?:number | null,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["party_claim_order_by"][],	/** filter the rows returned */
...
party_contribution?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["party_contribution_select_column"][],	/** limit the number of rows returned */
	limit?:number | null,	/** skip the first n rows. Use only with order_by */
	offset?:number | null,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["party_contribution_order_by"][],	/** filter the rows returned */
	where?:ValueTypes["party_contribution_bool_exp"] | null},ValueTypes["party_contribution"]],
party_contribution_aggregate?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["party_contribution_select_column"][],	/** limit the number of rows returned */
	limit?:number | null,	/** skip the first n rows. Use only with order_by */
	offset?:number | null,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["party_contribution_order_by"][],	/** filter the rows returned */
	where?:ValueTypes["party_contribution_bool_exp"] | null},ValueTypes["party_contribution_aggregate"]],
party_contribution_by_pk?: [{	id:number},ValueTypes["party_contribution"]],
party_created?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["party_created_select_column"][],	/** limit the number of rows returned */
	limit?:number | null,	/** skip the first n rows. Use only with order_by */
	offset?:number | null,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["party_created_order_by"][],	/** filter the rows returned */
...
party_finalized?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["party_finalized_select_column"][],	/** limit the number of rows returned */
	limit?:number | null,	/** skip the first n rows. Use only with order_by */
	offset?:number | null,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["party_finalized_order_by"][],	/** filter the rows returned */
...
run?: [{	/** distinct select on columns */
	...
	where?:ValueTypes["run_bool_exp"] | null},ValueTypes["run"]],
...
/** select columns of table "bid" */
export const enum bid_select_column {
	amount = "amount",
...
/** select columns of table "block" */
export const enum block_select_column {
	blockNumber = "blockNumber",
	blockTimestamp = "blockTimestamp",
	id = "id"
}
/** select columns of table "ens_lookup" */
export const enum ens_lookup_select_column {
	address = "address",
	ensName = "ensName",
	fetchedAt = "fetchedAt",
	found = "found",
...
/** select columns of table "eth_price" */
export const enum eth_price_select_column {
	fetchedAt = "fetchedAt",
	id = "id",
	priceUsd = "priceUsd"
}
/** select columns of table "open_sea_metadata" */
export const enum open_sea_metadata_select_column {
...
/** select columns of table "party_claim" */
export const enum party_claim_select_column {
	blockNumber = "blockNumber",
...
/** select columns of table "party_contribution" */
export const enum party_contribution_select_column {
	blockNumber = "blockNumber",
...
/** select columns of table "party_created" */
export const enum party_created_select_column {
	blockNumber = "blockNumber",
	createdBy = "createdBy",
	id = "id",
	partyAddress = "partyAddress",
...
/** select columns of table "party_finalized" */
export const enum party_finalized_select_column {
	blockNumber = "blockNumber",
	feeWei = "feeWei",
	id = "id",
	partyAddress = "partyAddress",
...
/** select columns of table "party" */
export const enum party_select_column {
	auctionId = "auctionId",
	blockNumber = "blockNumber",
	createdBy = "createdBy",
...
/** select columns of table "run" */
export const enum run_select_column {
	fromBlock = "fromBlock",
	id = "id",
	ranAt = "ranAt",
	runTime = "runTime",
